...
async function drive() {
  ...
  try {
    ...
    check('every remixable block shows its swatch placeholders on load', rails.length === 4 && rails.reduce((n, r) => n + r.placeholders, 0) === 12 && rails.every((r) => r.count === 0), JSON.stringify(rails))

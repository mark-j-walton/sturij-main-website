...
function build(THREE){
  ...
  var glass=new THREE.MeshPhysicalMaterial({color:0xffffff,metalness:0,transmission:1,roughness:0,ior:1.12,clearcoat:1,clearcoatRoughness:.03,specularIntensity:1});
  /* crystal clear: no tint, near-zero attenuation */
  glass.attenuationColor=new THREE.Color('#ffffff');glass.attenuationDistance=100;
  ...
  loadRoom();
  if('dispersion' in glass)glass.dispersion=0;
  ...
  img.onload=function(){
    ...
    var size2d=Math.max(cw,ch),depthU=.016*size2d,bev=depthU*.4;
